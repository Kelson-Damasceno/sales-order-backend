...
export class SalesOrderHeaderServiceImpl implements SalesOrderHeaderService {
    ...
    private async getProductsByIds(params: SalesOrderHeader): Promise<ProductModel[] | null> {
        const productIds: string[] = params.items?.map((item: SalesOrderItem) => item.product_id) as string[];
...
// const items = SalesOrderItemModel.create({
            
//         })
//         SalesOrderHeaderModel.create({
//             customerId: params.customer_id as string,
//         })